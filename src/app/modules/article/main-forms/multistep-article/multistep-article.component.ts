...
@Component({
  selector: 'app-multistep-article',
  templateUrl: './multistep-article.component.html',
  styleUrls: ['./multistep-article.component.css']
})
export class MultistepArticleComponent implements OnInit {
