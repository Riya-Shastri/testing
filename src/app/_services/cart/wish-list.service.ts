...
export class WishListService {
  // wishlist array
  public wishlistProducts: BehaviorSubject<Article[]> = new BehaviorSubject([]);
  ...
  // Add to wishlist
  public addToWishlist(product: Article): Article | boolean {
  ...
  // Removed Product
  public removeFromWishlist(product: Article) {
